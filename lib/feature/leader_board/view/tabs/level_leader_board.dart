...
class LevelLeaderBoard extends StatefulWidget {
  ...
  @override
  State<LevelLeaderBoard> createState() => _XpLeaderBoardState();
}

class _XpLeaderBoardState extends State<LevelLeaderBoard> with LoadingMixin {
  final thirdMap = {
          ...
          return !isLoggedIn ? Center(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final user = widget.controller.levelLeaderboard[index];
                final authService = getIt<AuthService>();
                ...
                return ListTile(
                  ...
                  trailing: Text("${user.level}", style: theme.textTheme.bodyMedium?.copyWith(
